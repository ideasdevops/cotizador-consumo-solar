...
echo "🔧 Configurando NocoDB para Cotizador Solar"
echo "============================================="
...
echo "- nocodb-structure.csv (estructura de columnas)"
echo "- nocodb-columns-config.json (configuración detallada)"
echo "- setup-nocodb.sh (este script)"
echo ""
echo "🚀 Pasos siguientes:"
echo "1. Importa el archivo nocodb-structure.csv a NocoDB"
echo "2. Crea las tablas con las columnas especificadas"
echo "3. Obtén los TABLE_ID de cada tabla creada"
